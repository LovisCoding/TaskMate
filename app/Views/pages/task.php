...
<div class="container mt-3">
	<div class="row" style="width: 100%;">
		<div class="col-6 p-5 bg-white rounded-2">
			<?= view('components/Input', ['name' => 'task_name', 'label' => null, 'type' => 'default', 'placeholder' => 'Nom de la tache']) ?>
			<textarea class="form-control mb-3 mt-3" placeholder="Description" rows="5"></textarea>
		...
		<div class="col-2"></div>
		<div class="col-4">
			<div class="p-5 bg-white rounded-2" style="height: fit-content;">
			...
			<div class="d-flex justify-content-center mt-5">
				<?= view('components/Button', ['text' => "Enregistrer les modifications", 'type' => 'blue']) ?>
			</div>
		</div>
