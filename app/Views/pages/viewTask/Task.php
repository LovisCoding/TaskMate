...
<div class="container mt-3">
	<div class="d-flex justify-content-start mb-5 button-container mt-5">
		...
		<?= view('components/Button', ['text' => "<strong>Enregistrer les modifications</strong>", 'type' => null, 'name' => 'action', 'value' => 'save', 'disabled' => $state == 'Terminée' || $state == 'Bloquée', 'svgName' => 'download']) ?>
	</div>
	<div class="row w-100">
